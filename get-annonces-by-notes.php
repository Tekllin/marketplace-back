...
try {
    ...
    AVG(CASE WHEN Avis.valid = 1 THEN Avis.noteAvis ELSE NULL END) as averageNote, MIN(Image.libelleImage) as image, count(idProduitAvis) as NbNotes
    FROM produits
