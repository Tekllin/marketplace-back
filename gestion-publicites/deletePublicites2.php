...
try {
    ...
    $fetch_post = "SELECT * FROM `publicites2` WHERE idPub = :id";
    ...
    if ($fetch_stmt->rowCount() > 0) :
            ...
            $delete_post = "DELETE FROM `publicites2` WHERE idPub = :id";
            $delete_post_stmt = $conn->prepare($delete_post); 
            $delete_post_stmt->bindValue(':id', $id,PDO::PARAM_INT);

            $deleteI_post = "DELETE FROM `imagepub2` WHERE idPubliciteImage = :id";
