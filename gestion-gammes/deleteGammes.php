...
try {
    ...
    if ($fetch_stmt->rowCount() > 0) :
        ...
        $fetch_count = "SELECT count(*) as count FROM categories where idGammeCategorie = :id AND idGammeCategorie in (SELECT idGamme FROM gammes)";
        ...
        if($dataC['count'] != 0) {
            ...
            $delete_post = "DELETE FROM `gammes` WHERE idGamme = :id";
