<?php
    ...
    try 
    {
        $fetch_post = "SELECT idAnnonceur, libelleNomAnnonceur, adresseAnnonceur, villeAnnonceur, cpAnnonceur, logoAnnonceur, siretAnnonceur, motivAnnonceur, idEtat FROM annonceurs WHERE idAnnonceur = :idAnnonceur";
