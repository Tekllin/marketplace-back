<?php
    ...
    try 
    {
        $fetch_post = "SELECT idAnnonceFacture, idPaiementAnnoFacture, idAdresseAnnoFacture, idAnnonceurAnnoFacture, dateAnnoFacture FROM annoncefacture WHERE idAnnonceFacture = :idFacture";
        ...
        if ($fetch_stmt->rowCount() > 0) :
            ...
            $delete_post = "DELETE FROM `annoncefacture` WHERE idAnnonceFacture=:idFacture";
