<?php
    ...
    try 
    {
        ...
        $query = "INSERT INTO `user`(nomUser,prenomUser,emailUser,passwordUser,telUser,tokenInsc,idDroitUser)
        VALUES(:nomUser,:prenomUser,:emailUser,:passwordUser,:telUser,:tokenInsc,:idDroitUser)";
