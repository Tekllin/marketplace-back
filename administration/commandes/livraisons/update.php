<?php
    ...
    try 
    {
        ...
        if ($fetch_stmt->rowCount() > 0) :
            ...
            $idUserAdresse = isset($data->idUserAdresse) ? $data->idUserAdresse : $row['idUserAdresse'];
            $libelleAdresse = isset($data->libelleAdresse) ? $data->libelleAdresse : $row['libelleAdresse'];
            $cpAdresse = isset($data->cpAdresse) ? $data->cpAdresse : $row['cpAdresse'];
            $villeAdresse = isset($data->villeAdresse) ? $data->villeAdresse : $row['villeAdresse'];
            $paysAdresse = isset($data->paysAdresse) ? $data->paysAdresse : $row['paysAdresse'];
            $etiquetteAdresse = isset($data->etiquetteAdresse) ? $data->etiquetteAdresse : $row['etiquetteAdresse'];

            $update_query = "UPDATE `livraisons` 
